...
# f = open("lattice_tm_input.txt", "w")

# for lattice in lattices: 
#   for state_idx, state in enumerate(lattice): 
#     for word, prob, d_state in state:  
#       f.write(str(state_idx) + " " + str(state_idx+d_state) + " " + word + " " + word + " " + str(prob) + "\n")
#   f.write("\n")
...
def jointly_process_files(corpus_root, prefix):
    ...
    gold_path = corpus_root + "/oracle/" + prefix + ".es"
    trans_path = corpus_root + "/plf/" + prefix + ".en"
